...
public static class SavWav
{
    ...
    static AudioClip RemoveUnused(AudioClip clip)
    {
        //Capture the current clip data
        
        var position = Microphone.GetPosition(""); // or deviceName
    ...
    public static AudioClip Save(string filename, AudioClip recordedClip, bool trim = false)
    {
        AudioClip clip = RemoveUnused(recordedClip);
    ...
    public static AudioClip GetWav(AudioClip clip, out uint length, out byte[] data, bool trim = false)
    {
        var newClip = RemoveUnused(clip);
        data = ConvertAndWrite(newClip, out length, out var samples, trim);

        WriteHeader(data, newClip, length, samples);
